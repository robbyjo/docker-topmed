...
RUN cd /home && \
  echo "pedigreemm,data.table,filematrix,kinship2,coxme,plyr,reshape2,ggplot2,SuppDists,gee,geepack,betareg,censReg,gamlss,MASS,mlogit,logistf,pscl,quantreg,robust,survival,truncreg,Zelig,ZeligChoice,ZeligEI,zoo,car,metafor,robustrlmm,pls,pspearman,mice,mediation,moments,randomForest,lubridate,tidyr,sqldf,SKAT,seriation,R.utils,e1071,Hmisc,grImport,lavaan,bnlearn,devtools,doMC,lars,ncdf4,Matrix,foreign,openxlsx,zip,xfun,formatR,yaml,stringi,stringr,magrittr,glue,mime,markdown,highr,knitr,jsonlite,htmltools" | tr ',' '\n' > /home/pkgs.txt && \
